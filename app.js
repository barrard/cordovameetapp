...
app.post('/socket.io*', function(){
console.log('()()( GOT A POOOOLLLLINNGGG POST-----------------------')
...
socket.on('blockClick', function(data){
  ...
  socket.broadcast.emit('blockMove', data)
})
...
socket.on('mapWasClicked', function(username){
  console.log('user: '+username+' Clicked on the map')
})
